...
import 'package:ecotaxi_app/src/res/dialog/loading_dialog.dart';
import 'package:ecotaxi_app/src/res/dialog/msg_dilog.dart';
                    ...
                    builder: (context, snapshot) => TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: Container(
                              width: 50, child: Image.asset("assets/ico/ic_user.png")),
              ...
              StreamBuilder(
                  ...
                  builder: (context, snapshot) => TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        snapshot.hasError ? snapshot.error : null,
                        prefixIcon: Container(
                            width: 50, child: Image.asset("assets/ico/ic_phone.png")),
                        border: OutlineInputBorder(
                            borderSide: BorderSide(
                                color: Color(0xffCED0D2), width: 1),
                            borderRadius:
                ...
                child: StreamBuilder(
                    ...
                    builder: (context, snapshot) => TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          snapshot.hasError ? snapshot.error : null,
                          prefixIcon: Container(
                              width: 50, child: Image.asset("assets/ico/ic_mail.png")),
                          border: OutlineInputBorder(
                              borderSide: BorderSide(
                                  color: Color(0xffCED0D2), width: 1),
                              borderRadius:
              ...
              StreamBuilder(
                  ...
                  builder: (context, snapshot) => TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelText: "Password",
                        prefixIcon: Container(
                            width: 50, child: Image.asset("assets/ico/ic_lock.png")),
                        border: OutlineInputBorder(
                            borderSide: BorderSide(
                                color: Color(0xffCED0D2), width: 1),
                            borderRadius:
